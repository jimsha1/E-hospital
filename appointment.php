...
if(isset($_POST['sub']))
{
    ...
    if(mysqli_num_rows($query)>0){
      ...
      mysqli_query($conn,"insert into appointment_tb(patient_id,doctor_id,Name,Phone_no,Department,Date,Time,Message,Medicine) values ('$patient_id','$doctor_id','$name','$phoneno','$department','$date','$time','$message',0)");
          ...
          <div class="form_container contact-form">
            ...
            <div class="form-row">
              ...
              <div class="form-row">
                <div class="col-lg-6">
                  <div>
                    <input type="date" name="date" required placeholder="Appointment date" />
                  </div>
                </div>
                <div class="col-lg-6">
                  <div>
                    <input type="time" name="time" required placeholder="Suitable time" />
                  </div>
                </div>
              </div>
              <div class="form-row">
              ...
              <div class="btn_box">
              <button type="submit" name="sub" >Make An Appointment</button>
              </div>
</section>
</div>
 <!-- footer section -->
