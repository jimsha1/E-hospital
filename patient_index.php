        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="medicine_view.php">Medicine</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="feedback.php">Feed Back/Complaint</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="chat_in.php">Chat with Doctor</a>
              </li>
              <li class="nav-item">
