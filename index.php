            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="registration.php" id="dropdown" data-toggle="dropdown" aria-expanded="false">Registration <i class="icofont-thin-down"></i></a>
                  <ul class="dropdown-menu" aria-labelledby="dropdown">
                    <li><a class="dropdown-item" href="doctor_reg.php">Doctor</a></li>
                    <li><a class="dropdown-item" href="patient_reg.php">Patient</a></li>
                  </ul>
              <li class="nav-item">
