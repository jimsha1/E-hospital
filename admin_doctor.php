...
$query=mysqli_query($conn,"select * from doctor_reg");
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <form action="" method="post">
                <table class="pure-table pure-table-bordered">
                    ...
                    <tr>
                            ...
                            {
                              ?>
                             <td><a href="admin_edit.php?edit_id=<?php echo $row['doctor_id'];?>" class="btn btn-primary" name="edit" value="edit"> pending</a></td>
                             <?php 
                            }
                            else{
                              ?>
