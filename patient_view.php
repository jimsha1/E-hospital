...
if(mysqli_num_rows($query)>0){
  ...
  $qry=mysqli_query($conn,"select * from appointment_tb where doctor_id='$doctor_id'");
}
        ...
        <form action="" method="post">
                <table class="pure-table pure-table-bordered">
                    ...
                    <tr>
                            ...
                            <td><a class="btn_box" name="submit" href="upload.php?edit_id=<?php echo $row['patient_id'];?>"> Upload</a></td>
                    </tr>
                    <?php
                    }
                    ?>
